    ...
    <div class="w-64 flex flex-col h-full">
      ...
      <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <div class="pt-6 mt-6 border-t border-gray-100">
           <p class="px-2 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Account</p>
           
           <RouterLink :to="{ name: 'profile' }" class="flex items-center px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-50 hover:text-seal-teal transition-colors group">
              <svg class="w-4 h-4 mr-3 text-gray-400 group-hover:text-seal-teal shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
              <span class="font-medium text-sm">Profile</span>
           </RouterLink>

           <RouterLink :to="{ name: 'settings' }" class="flex items-center px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-50 hover:text-seal-teal transition-colors group">
