...
<template>
  <div class="flex h-screen bg-transparent font-sans text-seal-dark dark:text-gray-100 transition-colors duration-300">
    ...
    <div class="flex-1 flex flex-col overflow-hidden relative z-0">
      ...
      <header class="h-16 bg-white/80 dark:bg-slate-800/80 backdrop-blur-md border-b border-white/50 dark:border-slate-700/50 shadow-sm flex items-center justify-between px-6 shrink-0 z-20 relative transition-colors duration-300">
        ...
        <div class="flex items-center space-x-5 relative">
          ...
          <div 
            ...
            class="absolute right-0 top-12 mt-2 w-56 bg-white/70 dark:bg-slate-800/80 backdrop-blur-md rounded-2xl shadow-lg py-2 border border-white/60 dark:border-slate-700/50 z-50 transition-colors duration-300"
          >
            <RouterLink to="/dashboard/profile" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-white/60 dark:hover:bg-slate-700/50 transition-colors flex items-center justify-between">
              <div class="flex items-center space-x-3">
                <svg class="w-5 h-5 text-gray-400 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                <span>Profile</span>
              </div>
            </RouterLink>

            <RouterLink :to="{ name: 'notifications' }" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-white/60 dark:hover:bg-slate-700/50 transition-colors flex items-center justify-between">
              <div class="flex items-center space-x-3">
            ...
            <RouterLink :to="{ name: 'settings' }" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-white/60 dark:hover:bg-slate-700/50 transition-colors flex items-center justify-between">
              <div class="flex items-center space-x-3">
            ...
            <div class="border-t border-white/40 dark:border-slate-700/50 my-1"></div>
            
            <button class="w-full text-left block px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-white/60 dark:hover:bg-red-900/20 transition-colors flex items-center space-x-3">
