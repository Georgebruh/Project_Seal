...
<template>
  <div class="flex h-screen bg-seal-light dark:bg-slate-900 font-sans text-seal-dark dark:text-gray-100 transition-colors duration-300">
    
    <Sidebar :isCollapsed="isSidebarCollapsed" />

    <div class="flex-1 flex flex-col overflow-hidden relative">
      
      <header class="h-16 bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 flex items-center justify-between px-6 shrink-0 z-10 transition-colors duration-300">
        ...
        <div class="flex items-center space-x-5 relative">
          ...
          <div 
            ...
            class="absolute right-0 top-12 mt-2 w-56 bg-white rounded-md shadow-lg py-1 border border-gray-200 z-50"
          >
            <RouterLink to="/dashboard/profile" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-between">
            ...
            <RouterLink :to="{ name: 'notifications' }" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-between">
              <div class="flex items-center space-x-3">
            ...
            <RouterLink :to="{ name: 'settings' }" class="w-full text-left block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-between">
              <div class="flex items-center space-x-3">
            ...
            <button class="w-full text-left block px-4 py-2 text-sm text-red-600 hover:bg-red-50 transition-colors flex items-center space-x-3">
